...
import com.mac.martial_arts_cms.repository.VideoRepository;
import com.mac.martial_arts_cms.service.inf.VideoService;
import com.mac.martial_arts_cms.utils.CommonConstants;
import com.mac.martial_arts_cms.utils.DateTimeUtils;
...
public class VideoServiceImpl implements VideoService {
    ...
    public void deleteVideo(Long id) {
        ...
        if(video.isPresent()) {
            ...
            throw new UsernameNotFoundException(messageUtils.getMessage(CommonConstants.MessageError.ER041, null));
        }
